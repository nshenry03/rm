...
case "${APP}" in
  appdirect)  echo "Copying XML for AppDirect DB for Release ${VERSION}"
    ...
    DIST_HOSTS=(prod-att-ae1-dist01 prod-aws00-dist01 prod-comcast00-dist01 prod-de00-dist01 prod-elisa-hel-dist01 prod-ibm-dal-dist01 prod-kor00-distribution01 prod-or00-dist01 prod-swiss00-dist01 prod-swiss01-dist01 prod-tel-ap2-dist01 stage0-aws-ae1-dist02)
    ;;
  ...
  jbilling)  echo  "Copying XML for JBilling DB for Release ${VERSION}"
    ...
    DIST_HOSTS=(prod-aws00-dist01 prod-comcast00-dist01 prod-de00-dist01 prod-elisa-hel-dist01 prod-ibm-dal-dist01 prod-kor00-distribution01 prod-or00-dist01 prod-swiss00-dist01 prod-swiss01-dist01 prod-tel-ap2-dist01 stage0-aws-ae1-dist02)
    ;;
esac
